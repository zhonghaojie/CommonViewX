package com.lege.legecommonview.videoplayer.cache;
...
public class PreloadManager {
     ...
     */
    public static final int PRELOAD_LENGTH =1 * 1024 * 1024;
    ...
    public void addPreloadTask(String rawUrl, int position) {
        ...
        Log.i("DKPLAYER","addPreloadTask: " + position);
    ...
    public void pausePreload(int position, boolean isReverseScroll) {
        Log.i("DKPLAYER","pausePreload：" + position + " isReverseScroll: " + isReverseScroll);
    ...
    public void resumePreload(int position, boolean isReverseScroll) {
        Log.i("DKPLAYER","resumePreload：" + position + " isReverseScroll: " + isReverseScroll);
