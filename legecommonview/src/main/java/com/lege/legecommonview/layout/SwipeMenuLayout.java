...
public class SwipeMenuLayout extends ViewGroup {
    ...
    private SwipeMenuItemStateChangeListener stateChangeListener;

    public SwipeMenuItemStateChangeListener getStateChangeListener() {
        return stateChangeListener;
    }

    public void setStateChangeListener(SwipeMenuItemStateChangeListener stateChangeListener) {
        ...
        mExpandAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if(stateChangeListener!=null){
                    stateChangeListener.stateChange(isExpand);
                }
            }
        });
